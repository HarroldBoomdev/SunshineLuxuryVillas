  ...
  <div class="card-body">
    <div class="row g-3">
      <div class="col-md-6">
        ...
        <input type="number" name="area_covered" class="form-control" step="0.01" min="0" value="{{ old('area_covered') }}">
      </div>
      <div class="col-md-6">
        <label class="form-label">Plot m²</label>
        <input type="number" name="area_plot" class="form-control" step="0.01" min="0" value="{{ old('area_plot') }}">
      </div>

      <div class="col-md-6">
        <label class="form-label">Attic m²</label>
        <input type="number" name="area_attic" class="form-control" step="0.01" min="0" value="{{ old('area_attic') }}">
      </div>
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        ...
        <input type="number" name="area_cov_veranda" class="form-control" step="0.01" min="0" value="{{ old('area_cov_veranda') }}">
      </div>
      <div class="col-md-6">
        <label class="form-label">Uncovered Veranda m²</label>
        <input type="number" name="area_uncov_veranda" class="form-control" step="0.01" min="0" value="{{ old('area_uncov_veranda') }}">
      </div>

      <div class="col-md-6">
        <label class="form-label">Covered Parking m²</label>
        <input type="number" name="area_cov_parking" class="form-control" step="0.01" min="0" value="{{ old('area_cov_parking') }}">
      </div>
      <div class="col-md-6">
        <label class="form-label">Basement m²</label>
        <input type="number" name="area_basement" class="form-control" step="0.01" min="0" value="{{ old('area_basement') }}">
      </div>

      <div class="col-md-6">
        <label class="form-label">Courtyard m²</label>
        <input type="number" name="area_courtyard" class="form-control" step="0.01" min="0" value="{{ old('area_courtyard') }}">
      </div>
      <div class="col-md-6">
        <label class="form-label">Garden m²</label>
        <input type="number" name="area_garden" class="form-control" step="0.01" min="0" value="{{ old('area_garden') }}">
      </div>
    </div>
  </div>
</div>
